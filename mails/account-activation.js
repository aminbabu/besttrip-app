/**
 * @file /mails/account-activation.js
 * @project best-trip
 * @version 0.0.0
 * @author best-trip
 * @date 09 June, 2024
...
module.exports = async (user) => {
    ...
    const template = fs.readFileSync(
        `${__dirname}/../templates/email/account-activation.ejs`,
        'utf-8'
    );
    ...
    return {
        ...
        text: 'Successfully your account has been activated. You can now login to your account',
        html,
        attachments,
    };
};
