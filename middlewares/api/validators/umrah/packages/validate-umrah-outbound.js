/**
 * @file /middlewares/api/validators/umrah/packages/validate-umrah-outbound.js
 * @project best-trip
 * @version 0.0.0
 * @author best-trip
 * @date 14 May, 2024
...
module.exports = (req, res, next) => {
    ...
    const data = filterReqFromZodSchema(req.body, umrahOutboundSchema.shape);

    // validate request body
    const { error, success } = umrahOutboundSchema.safeParse(data);
