...
var KTApiFlightList = (function () {
  ...
  var handleSearch = function () {
    const filterSearch = document.querySelector(
      '[data-kt-api-flight-table-filter="search"]'
    );
  ...
  var handleFilter = function () {
    ...
    const filterForm = document.querySelector(
      '[data-kt-api-flight-table-filter="form"]'
    );
    const filterButton = filterForm.querySelector(
      '[data-kt-api-flight-table-filter="filter"]'
    );
    const resetButton = filterForm.querySelector(
      '[data-kt-api-flight-table-filter="reset"]'
    );
  ...
  var handleRowDeletion = function () {
    ...
    const deleteButtons = table.querySelectorAll(
      '[data-kt-api-flight-table-filter="delete_row"]'
    );
  ...
  var initToggleToolbar = () => {
    ...
    toolbarBase = document.querySelector(
      '[data-kt-api-flight-table-toolbar="base"]'
    );
    toolbarSelected = document.querySelector(
      '[data-kt-api-flight-table-toolbar="selected"]'
    );
    selectedCount = document.querySelector(
      '[data-kt-api-flight-table-select="selected_count"]'
    );
    const deleteSelected = document.querySelector(
      '[data-kt-api-flight-table-select="delete_selected"]'
    );
  ...
  return {
    // Public functions
    init: function () {
      table = document.getElementById("kt_api_flight_table");
