...
var KTNewslettersList = (function () {
  ...
  var handleSearch = function () {
    const filterSearch = document.querySelector(
      '[data-kt-newsletter-table-filter="search"]'
    );
  ...
  var handleFilter = function () {
    ...
    const filterForm = document.querySelector(
      '[data-kt-newsletter-table-filter="form"]'
    );
    const filterButton = filterForm.querySelector(
      '[data-kt-newsletter-table-filter="filter"]'
    );
    const resetButton = filterForm.querySelector(
      '[data-kt-newsletter-table-filter="reset"]'
    );
  ...
  var handleRowDeletion = function () {
    ...
    const deleteButtons = table.querySelectorAll(
      '[data-kt-newsletter-table-filter="delete_row"]'
    );
  ...
  var initToggleToolbar = () => {
    ...
    toolbarBase = document.querySelector(
      '[data-kt-newsletter-table-toolbar="base"]'
    );
    toolbarSelected = document.querySelector(
      '[data-kt-newsletter-table-toolbar="selected"]'
    );
    selectedCount = document.querySelector(
      '[data-kt-newsletter-table-select="selected_count"]'
    );
    const deleteSelected = document.querySelector(
      '[data-kt-newsletter-table-select="delete_selected"]'
    );
  ...
  var initForm = function () {
    ...
    $('[data-kt-newsletter-table-filter][name="date"]').flatpickr({
      altInput: true,
      altFormat: "F j, Y",
      dateFormat: "Y-m-d",
      mode: "range",
  ...
  return {
    // Public functions
    init: function () {
      table = document.getElementById("kt_newsletter_table");
