...
var KTPackageEdit = (function () {
    ...
    const element = document.getElementById(
        'kt_umrah_extranet_package_duration_edit_modal'
    );
    const form = element.querySelector(
        '#kt_umrah_extranet_package_duration_edit_form'
    );
    ...
    var initEditPackage = () => {
        ...
        const submitButton = element.querySelector(
            '#kt_umrah_extranet_package_duration_edit_submit'
        );
        ...
        const cancelButton = element.querySelector(
            '#kt_umrah_extranet_package_duration_edit_cancel'
        );
        ...
        const closeButton = element.querySelector(
            '#kt_umrah_extranet_package_duration_edit_close'
        );
    ...
    const populateData = async () => {
        const editButtons = document.querySelectorAll(
            '[data-kt-umrah-extranet-package-duration-table-filter="edit_row"]'
        );
        ...
        editButtons.forEach((button) => {
            button.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (response) {
                        const data = response.data.umrahPackageDuration;
                        form.querySelector('[name="days"]').value = data.days;
                        form.querySelector('[name="nights"]').value =
                            data.nights;
                        $(form)
        ...
        toggleButtons.forEach((button) => {
            button.addEventListener('change', async () => {
                const url = button.getAttribute(
                    'data-kt-umrah-package-duration-url'
                );
