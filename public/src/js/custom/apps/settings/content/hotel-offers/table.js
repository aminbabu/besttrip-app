...
var KTContentHotelOffers = (function () {
    ...
    var handleSearch = function () {
        const filterSearch = document.querySelector(
            '[data-kt-content-hotel-offers-table-filter="search"]'
        );
    ...
    return {
        // Public functions
        init: function () {
            table = document.getElementById('kt_content_hotel_offers_table');
