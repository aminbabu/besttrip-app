...
var KTContentBlogPosts = (function () {
  ...
  var handleSearch = function () {
    const filterSearch = document.querySelector(
      '[data-kt-content-blog-posts-table-filter="search"]'
    );
  ...
  var handleRowDeletion = function () {
    ...
    const deleteButtons = table.querySelectorAll(
      '[data-kt-content-blog-posts-table-filter="delete_row"]'
    );
  ...
  var initToggleToolbar = () => {
    ...
    toolbarBase = document.querySelector(
      '[data-kt-content-blog-posts-table-toolbar="base"]'
    );
    toolbarSelected = document.querySelector(
      '[data-kt-content-blog-posts-table-toolbar="selected"]'
    );
    selectedCount = document.querySelector(
      '[data-kt-content-blog-posts-table-select="selected_count"]'
    );
    const deleteSelected = document.querySelector(
      '[data-kt-content-blog-posts-table-select="delete_selected"]'
    );
  ...
  return {
    // Public functions
    init: function () {
      table = document.getElementById("kt_content_blog_posts_table");
