...
var KTContentFlightOffers = (function () {
    ...
    var handleSearch = function () {
        const filterSearch = document.querySelector(
            '[data-kt-content-flight-offers-table-filter="search"]'
        );
    ...
    var handleRowDeletion = function () {
        ...
        const deleteButtons = table.querySelectorAll(
            '[data-kt-content-flight-offers-table-filter="delete_row"]'
        );
    ...
    var initToggleToolbar = () => {
        ...
        toolbarBase = document.querySelector(
            '[data-kt-content-flight-offers-table-toolbar="base"]'
        );
        toolbarSelected = document.querySelector(
            '[data-kt-content-flight-offers-table-toolbar="selected"]'
        );
        selectedCount = document.querySelector(
            '[data-kt-content-flight-offers-table-select="selected_count"]'
        );
        const deleteSelected = document.querySelector(
            '[data-kt-content-flight-offers-table-select="delete_selected"]'
        );
    ...
    return {
        // Public functions
        init: function () {
            table = document.getElementById('kt_content_flight_offers_table');
