...
// Class definition
var KTContentUmrahOfferEdit = (function () {
    // Shared variables
    const element = document.getElementById(
        'kt_content_umrah_offers_edit_modal'
    );
    const form = element.querySelector('#kt_content_umrah_offers_edit_form');
    ...
    var initEditContentExclusiveOffer = () => {
        ...
        const submitButton = element.querySelector(
            '#kt_content_umrah_offers_edit_submit'
        );
        ...
        const cancelButton = element.querySelector(
            '#kt_content_umrah_offers_edit_cancel'
        );
        ...
        const closeButton = element.querySelector(
            '#kt_content_umrah_offers_edit_close'
        );
    ...
    const toggleStatus = async () => {
        ...
        toggleButtons.forEach((button) => {
            button.addEventListener('change', async () => {
                const url = button.getAttribute('data-kt-umrah-offer-url');
    ...
    const populateData = async () => {
        const editButtons = document.querySelectorAll(
            '[data-kt-content-umrah-offers-table-filter="edit_row"]'
        );
        ...
        editButtons.forEach((button) => {
            button.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (response) {
                        const data = response.data.umrahOffer;
