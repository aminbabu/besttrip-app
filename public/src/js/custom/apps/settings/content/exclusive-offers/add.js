...
var KTContentExclusiveOfferAdd = (function () {
  ...
  const form = element.querySelector("#kt_content_exclusive_offers_add_form");
  ...
  var initAddContentExclusiveOffer = () => {
    ...
    const submitButton = element.querySelector(
      "#kt_content_exclusive_offers_add_submit"
    );
    ...
    const cancelButton = element.querySelector(
      "#kt_content_exclusive_offers_add_cancel"
    );
    ...
    const closeButton = element.querySelector(
      "#kt_content_exclusive_offers_add_close"
    );
