...
var KTModalUpdateTicketNumber = (function () {
        ...
        validator = FormValidation.formValidation(form, {
            fields: {
                ticket_number1: {
                    validators: {
                        notEmpty: {
                            message: 'Ticket Number 1 is required',
                        },
                    },
                },
                ticket_number1: {
                    validators: {
                        notEmpty: {
                            message: 'Ticket Number 2 status is required',
                        },
                    },
                },
                ticket_number1: {
                    validators: {
                        notEmpty: {
                            message: 'Ticket Number 3 status is required',
                        },
                    },
                },
            },
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#kt_modal_update_ticket_number');
            ...
            form = element.querySelector('#kt_modal_update_ticket_number_form');
            submitButton = form.querySelector(
                '[data-kt-ticket_number-modal-action="submit"]'
            );
            cancelButton = form.querySelector(
                '[data-kt-ticket_number-modal-action="cancel"]'
            );
            closeButton = element.querySelector(
                '[data-kt-ticket_number-modal-action="close"]'
            );
