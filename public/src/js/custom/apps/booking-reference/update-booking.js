...
// Class definition
var KTModalUpdateBooking = (function () {
    var element;
    var submitButton;
    var cancelButton;
    var closeButton;
        ...
        validator = FormValidation.formValidation(form, {
            fields: {
                ...
                makkah_hotel_status: {
                    validators: {
                        notEmpty: {
                            message: 'Makkah Hotel status is required',
                        },
                    },
                },
                madinah_hotel_status: {
                    validators: {
                        notEmpty: {
                            message: 'Madinah Hotel status is required',
                        },
                    },
                },
                visa_status: {
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#kt_modal_update_booking');
            ...
            form = element.querySelector('#kt_modal_update_booking_form');
            submitButton = form.querySelector(
                '[data-kt-booking-modal-action="submit"]'
            );
            cancelButton = form.querySelector(
                '[data-kt-booking-modal-action="cancel"]'
            );
            closeButton = element.querySelector(
                '[data-kt-booking-modal-action="close"]'
            );
