...
var KTUsersLoginSessionList = (function () {
  // Define shared variables
  var table = document.getElementById("kt_table_users_login_session");
  var datatable;
  var toolbarBase;
  var toolbarSelected;
  var selectedCount;
  ...
  var handleResetForm = () => {
    ...
    const resetButton = document.querySelector(
      '[data-kt-users-login-session-filter="reset"]'
    );
  ...
  var initToggleToolbar = () => {
    ...
    toolbarBase = document.querySelector(
      '[data-kt-users-login-session-toolbar="base"]'
    );
