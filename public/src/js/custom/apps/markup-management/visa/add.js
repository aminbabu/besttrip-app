...
// Class definition
var KTMarkupVisaAdd = (function () {
  // Shared variables
  const element = document.getElementById("kt_modal_add_markup_visa");
  const form = element.querySelector("#kt_modal_add_markup_visa_form");
