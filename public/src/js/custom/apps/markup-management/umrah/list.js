...
var KTMarkupUmrahList = (function () {
  ...
  var handleSearch = function () {
    const filterSearch = document.querySelector(
      '[data-kt-markup-umrah-table-filter="search"]'
    );
  ...
  var handleFilter = function () {
    ...
    const filterForm = document.querySelector(
      '[data-kt-markup-umrah-table-filter="form"]'
    );
    const filterButton = filterForm.querySelector(
      '[data-kt-markup-umrah-table-filter="filter"]'
    );
    const resetButton = filterForm.querySelector(
      '[data-kt-markup-umrah-table-filter="reset"]'
    );
  ...
  var handleRowDeletion = function () {
    ...
    const deleteButtons = table.querySelectorAll(
      '[data-kt-markup-umrah-table-filter="delete_row"]'
    );
  ...
  var initToggleToolbar = () => {
    ...
    toolbarBase = document.querySelector(
      '[data-kt-markup-umrah-table-toolbar="base"]'
    );
    toolbarSelected = document.querySelector(
      '[data-kt-markup-umrah-table-toolbar="selected"]'
    );
    selectedCount = document.querySelector(
      '[data-kt-markup-umrah-table-select="selected_count"]'
    );
    const deleteSelected = document.querySelector(
      '[data-kt-markup-umrah-table-select="delete_selected"]'
    );
  ...
  return {
    // Public functions
    init: function () {
      table = document.getElementById("kt_markup_umrah_table");
