/**
 * @file /schemas/zod/umdah/packages/umrah-package.js
 * @project best-trip
 * @version 0.0.0
 * @author best-trip
 * @date 27 April, 2024
...
module.exports = z
    .object({
        ...
        type: z
            ...
            .refine((type) => UMDAH_PACKAGE_TYPES.includes(type), {
        ...
        status: z
            ...
            .refine((status) => UMDAH_PACKAGE_STATUS.includes(status), {
        ...
        inclusions: z
            .array(
                z
                    ...
                    .refine((inclusion) => UMDAH_PACKAGE_INCLUSIONS.includes(inclusion), {
        ...
        outboundFlightStops: z
            ...
            .refine(
                (outboundFlightStops) =>
                    UMDAH_PACKAGE_OUTBOUND_FLIGHT_STOPS.includes(outboundFlightStops),
                {
