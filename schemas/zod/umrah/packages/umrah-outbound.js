...
module.exports = z
    .object({
        ...
        outboundAirCraftModel: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound aircraft model must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundDepartureAirport: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound departure airport must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundArrivalAirport: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound arrival airport must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundDepartureDatetime: z
            ...
            .refine(
                (outboundDepartureDatetime) =>
                    moment(outboundDepartureDatetime, 'YYYY-MM-DD HH:mm', true).isValid(),
                {
                    message: 'Please provide a valid outbound departure datetime',
                }
            ),
        outboundArrivalDatetime: z
            ...
            .refine(
                (outboundArrivalDatetime) =>
                    moment(outboundArrivalDatetime, 'YYYY-MM-DD HH:mm', true).isValid(),
                {
        ...
        outboundFlightStops: z
            ...
            .refine(
                (outboundFlightStops) =>
                    UMRAH_PACKAGE_OUTBOUND_FLIGHT_STOPS.includes(+outboundFlightStops),
                {
        ...
        outboundLayoverFirstDuration: z
            ...
            .refine(
                (outboundLayoverFirstDuration) =>
                    moment(outboundLayoverFirstDuration, 'HH:mm', true).isValid(),
                {
                    message: 'Please provide a valid outbound layover first duration',
                }
            )
            .optional(),
        outboundLayoverFirstAirport: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound layover first airport must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundLayoverSecondDuration: z
            ...
            .refine(
                (outboundLayoverSecondDuration) =>
                    moment(outboundLayoverSecondDuration, 'HH:mm', true).isValid(),
                {
                    message: 'Please provide a valid outbound layover second duration',
                }
            )
            .optional(),
        outboundLayoverSecondAirport: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound layover second airport must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundAdultBaggageCheckin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound adult baggage checkin must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundChildBaggageCheckin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound child baggage checkin must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundInfantBaggageCheckin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound infant baggage checkin must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundAdultBaggageCabin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound adult baggage cabin must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundChildBaggageCabin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound child baggage cabin must be at least 1 characters',
            })
            .max(255, {
        ...
        outboundInfantBaggageCabin: z
            ...
            .trim()
            .min(1, {
                message: 'Outbound infant baggage cabin must be at least 1 characters',
            })
            .max(255, {
