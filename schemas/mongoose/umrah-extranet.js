...
module.exports = new Schema(
    {
        ...
        type: {
            type: String,
            enum: UMDAH_EXTRANET_TYPES,
            required: [true, 'Type is required'],
        },
        status: {
            type: String,
            enum: UMDAH_EXTRANET_STATUS,
            default: 'active',
        },
        adultPrice: {
            type: Number,
        ...
        inclusions: {
            type: [String],
            enum: UMDAH_EXTRANET_INCLUSIONS,
        ...
        outboundFlightStops: {
            type: Number,
            enum: UMDAH_EXTRANET_OUTBOUND_FLIGHT_STOPS,
            required: [true, 'Flight stops is required'],
        },
        outboundLayoverFirstDuration: {
            type: String,
            required: [
                () => this.outboundFlightStops === UMDAH_EXTRANET_OUTBOUND_FLIGHT_STOPS[1],
        ...
        outboundLayoverSecondDuration: {
            type: String,
            required: [
                () => this.outboundFlightStops === UMDAH_EXTRANET_OUTBOUND_FLIGHT_STOPS[2],
        ...
        inboundLayoverFirstDuration: {
            type: String,
            required: [
                () => this.inboundFlightStops === UMDAH_EXTRANET_OUTBOUND_FLIGHT_STOPS[1],
                'Layover 1st duration is required',
            ],
        },
        ...
        inboundLayoverSecondDuration: {
            type: String,
            required: [
                () => this.inboundFlightStops === UMDAH_EXTRANET_OUTBOUND_FLIGHT_STOPS[2],
                'Layover 2nd duration is required',
            ],
        },
